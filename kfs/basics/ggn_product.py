...
def ggnvp(
    ...
    r"""Multiply v with the GGN of f linearized at h w.r.t. x.
    ...
    Jv = jvp(h, x2, v, retain_graph=retain_graph)
    HJ_v = hvp(f, h, Jv, retain_graph=retain_graph)
    JTHJ_v = vjp(h, x1, HJ_v, retain_graph=retain_graph)
    return JTHJ_v
