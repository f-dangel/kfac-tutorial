...
The inputs are processed by the neural network $f: \Theta \times \mathcal{X} \to \mathcal{F}$ and the resulting predictions are scored with a criterion function $c: \gF \times \gY \to \sR$, such as mean-squared or softmax cross-entropy loss.
